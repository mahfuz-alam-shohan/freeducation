...
.social-page .post-head,.profile-page .post-head,.social-post-modal .post-head,.profile-post-modal-content .post-head{display:flex;gap:var(--space-2);align-items:flex-start;min-width:0}
...
.social-page .post-meta,.profile-page .post-meta,.social-post-modal .post-meta,.profile-post-modal-content .post-meta{display:grid;line-height:1.2;min-width:0;flex:1 1 auto}
.social-page .post-ops,.profile-page .post-ops,.social-post-modal .post-ops,.profile-post-modal-content .post-ops{position:relative;display:flex;align-items:flex-start;justify-content:flex-end;flex:0 0 auto}
.social-page .post-ops-trigger,.profile-page .post-ops-trigger,.social-post-modal .post-ops-trigger,.profile-post-modal-content .post-ops-trigger{display:inline-flex;align-items:center;justify-content:center;width:30px;height:30px;border:none;background:transparent;color:var(--text-muted);border-radius:999px;cursor:pointer}
.social-page .post-ops-trigger:hover,.profile-page .post-ops-trigger:hover,.social-post-modal .post-ops-trigger:hover,.profile-post-modal-content .post-ops-trigger:hover{background:var(--surface-soft);color:var(--text)}
.social-page .post-ops-trigger-icon,.profile-page .post-ops-trigger-icon,.social-post-modal .post-ops-trigger-icon,.profile-post-modal-content .post-ops-trigger-icon{width:16px;height:16px;display:block}
.social-page .post-ops-trigger-icon circle,.profile-page .post-ops-trigger-icon circle,.social-post-modal .post-ops-trigger-icon circle,.profile-post-modal-content .post-ops-trigger-icon circle{fill:currentColor}
.social-page .post-ops-menu,.profile-page .post-ops-menu,.social-post-modal .post-ops-menu,.profile-post-modal-content .post-ops-menu{position:absolute;top:calc(100% + 4px);right:0;min-width:148px;border:1px solid color-mix(in srgb,var(--border) 72%,var(--accent) 28%);border-radius:10px;background:var(--surface);box-shadow:0 10px 22px rgba(0,0,0,.2);padding:4px;display:grid;gap:2px;z-index:4}
.social-page .post-ops-item,.profile-page .post-ops-item,.social-post-modal .post-ops-item,.profile-post-modal-content .post-ops-item{height:32px;display:flex;align-items:center;gap:8px;width:100%;border:none;background:transparent;color:var(--text);border-radius:8px;padding:0 8px;cursor:pointer;font-size:.82rem;font-weight:600;text-align:left}
.social-page .post-ops-item:hover,.profile-page .post-ops-item:hover,.social-post-modal .post-ops-item:hover,.profile-post-modal-content .post-ops-item:hover{background:var(--surface-soft)}
.social-page .post-ops-item-icon,.profile-page .post-ops-item-icon,.social-post-modal .post-ops-item-icon,.profile-post-modal-content .post-ops-item-icon{width:15px;height:15px;display:block}
.social-page .post-ops-item.is-danger,.profile-page .post-ops-item.is-danger,.social-post-modal .post-ops-item.is-danger,.profile-post-modal-content .post-ops-item.is-danger{color:#d65a66}
