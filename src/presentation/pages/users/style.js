...
.users-card{background:var(--surface);border:1px solid var(--border);border-radius:var(--radius-sm);padding:var(--space-2);display:grid;gap:var(--space-2);animation:section-in .34s cubic-bezier(.22,.61,.36,1) both}
...
.users-toggle{display:inline-flex;align-items:center;justify-content:center;gap:var(--space-2);min-width:90px}
...
.users-panel{display:grid;gap:var(--space-2);border:1px solid var(--border);border-radius:var(--radius-sm);padding:0 var(--space-2);max-height:0;opacity:0;overflow:hidden;transform:translateY(-3px);transition:max-height .34s cubic-bezier(.22,.82,.31,1),opacity .24s ease,padding .2s ease,transform .34s cubic-bezier(.22,.82,.31,1)}
.users-panel.is-open{max-height:320px;opacity:1;padding:var(--space-2);transform:translateY(0)}
...
.users-delete-dialog{position:fixed;inset:0;background:color-mix(in srgb,var(--overlay) 92%,transparent);display:grid;place-items:end center;padding:var(--space-3);opacity:0;visibility:hidden;transition:opacity .2s ease,visibility .2s step-end;z-index:70}
.users-delete-dialog.is-open{opacity:1;visibility:visible;transition:opacity .2s ease}
.users-delete-surface{position:relative;background:var(--surface);border:1px solid var(--border);border-radius:var(--radius-md);width:min(460px,100%);padding:var(--space-3);display:grid;gap:var(--space-2);transform:translateY(10px) scale(.97);opacity:.86;transition:transform .34s cubic-bezier(.22,.82,.31,1),opacity .24s ease}
...
.users-delete-actions{display:flex;justify-content:flex-end;gap:var(--space-2);flex-wrap:wrap}
...
@media (max-width:700px){.users-card{padding:var(--space-2)}.users-panel.is-open{max-height:400px}.users-table{min-width:640px}.users-delete-dialog{place-items:end stretch}}
