...
if (!totalUsers || !activeSessions || !dashboardGrid) return;
...
fetch('/api/workspace/overview', { signal: controller.signal })
  .then((response) => response.json())
  .then((data) => {
    totalUsers.textContent = data.totalUsers ?? data.totalAdmins ?? '-';
