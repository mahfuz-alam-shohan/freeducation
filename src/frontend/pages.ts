...
const viewByPath = new Map<string, string>([
  ...
  ["/ssc/bangla-1st-paper/item/srijonshil", "public-bangla-ssc-item-srijonshil"],
  ["/ssc/bangla-1st-paper/item/mcq", "public-bangla-ssc-item-mcq"],
  ["/hsc/bangla-1st-paper/item", "public-bangla-hsc-item"],
  ["/hsc/bangla-1st-paper/item/srijonshil", "public-bangla-hsc-item-srijonshil"],
  ["/hsc/bangla-1st-paper/item/mcq", "public-bangla-hsc-item-mcq"],
  ["/login", "login"],
  ["/register", "register"],
  ["/dashboard", "dashboard"],
