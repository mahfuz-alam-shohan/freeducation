...
{view === 'public-ssc-bangladesh-global-studies-topics' && (
    <PublicScienceShell
        ...
        onBack={() => goBack('public-ssc-bangladesh-global-studies')}
        onNavigate={navigate}
    >
...
{view === 'public-ssc-bangladesh-global-studies-topic' && (
    <PublicScienceTopicDetail
        ...
        onBack={() => goBack('public-ssc-bangladesh-global-studies-topics')}
        onNavigate={navigate}
    />
)}
{view === 'public-ssc-bangladesh-global-studies-cq' && (
    <PublicScienceCqDetail
        ...
        onBack={() => goBack('public-ssc-bangladesh-global-studies-topic')}
        onNavigate={navigate}
    />
)}
...
{view === 'public-ssc-religion-chapters' && (
    <PublicScienceShell
        ...
        onBack={() => goBack('public-ssc-religion')}
        onNavigate={navigate}
    >
        <PublicScienceChapterList
            classLabel="SSC"
...
{view === 'public-ssc-religion-topics' && (
    <PublicScienceShell
        ...
        title={selectedScienceChapter?.name || 'অধ্যায় নির্বাচন করুন'}
        subtitle="টপিক নির্বাচন করুন"
        onBack={() => goBack('public-ssc-religion-chapters')}
        onNavigate={navigate}
    >
        <PublicScienceTopicList
            topics={selectedScienceChapter?.topics || []}
...
{view === 'public-ssc-religion-topic' && (
    <PublicScienceTopicDetail
        ...
        onBack={() => goBack('public-ssc-religion-topics')}
        onNavigate={navigate}
    />
)}
{view === 'public-ssc-religion-cq' && (
    <PublicScienceCqDetail
        ...
        onBack={() => goBack('public-ssc-religion-topic')}
        onNavigate={navigate}
    />
)}
