...
import { SITE_LOGO_CSS, renderSiteLogo } from "./siteLogo.js";
...
.admin-brand-signature .site-logo{width:100%;max-width:100%}
.admin-brand-signature .site-logo-svg{filter:drop-shadow(0 3px 9px color-mix(in srgb,var(--accent) 40%,transparent))}
