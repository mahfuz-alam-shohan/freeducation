...
.admin-brand-doodle-secondary{fill:none;stroke:color-mix(in srgb,var(--accent) 66%,#fff);stroke-width:1.15;stroke-linecap:round;stroke-linejoin:round;opacity:.76}
.admin-brand-spark{fill:color-mix(in srgb,var(--accent) 82%,#fff);opacity:.9}
...
const BRAND_SVG = `<svg class="admin-brand-svg" viewBox="0 0 248 52" aria-hidden="true" focusable="false"><defs><linearGradient id="adminBrandWordGradient" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="color-mix(in srgb,var(--accent) 95%,#fff)"/><stop offset="100%" stop-color="color-mix(in srgb,var(--accent) 56%,#3a2514)"/></linearGradient><radialGradient id="adminBrandSparkGradient" cx="50%" cy="50%" r="50%"><stop offset="0%" stop-color="color-mix(in srgb,var(--accent) 92%,#fff)"/><stop offset="100%" stop-color="color-mix(in srgb,var(--accent) 60%,transparent)"/></radialGradient></defs><text class="admin-brand-word admin-brand-word-shadow" x="14.6" y="36.4" font-size="28">Freeducation</text><text class="admin-brand-word admin-brand-word-extrude" x="13.2" y="35" font-size="28">Freeducation</text><text class="admin-brand-word admin-brand-word-front" x="12" y="33.8" font-size="28">Freeducation</text><path class="admin-brand-doodle" d="M10.8 38.6c8.1 6 18.7 6.8 29.8 3.6 11.5-3.4 22.8-3.9 34.4.7 9.5 3.8 18.8 4 28.3 1.3 9.2-2.6 18-2.6 27 .7 8.8 3.3 17.4 3.8 26.2 1.7 8.6-2.1 17-2.2 25.2.2 8.8 2.6 17.1 2.3 25.4-.6 6.8-2.3 13.6-2.8 20.2-.3"/><path class="admin-brand-doodle-secondary" d="M13.2 41.9c7 4.1 16.1 4.5 25.4 2 10.3-2.8 20.4-3 30.5.9m7.1-24.2c2.7 4.9 7.2 7.8 13.4 7 5-.6 9.4-2.8 14.1-2m11.5 17.4c9.4 4.5 19.4 4.5 29.5 1.7 9.7-2.7 19-2.9 28.2.6m10.1-19.4c4.7-4.8 11.8-7.1 18.2-6"/><path class="admin-brand-doodle-secondary" d="M31.4 16.5c5.8-4.4 13.2-5.8 20.3-4 5.4 1.4 10.5 4.6 15.9 4.7 4.2.1 8.2-1.6 12.1-3"/><circle class="admin-brand-spark" cx="62.8" cy="11.1" r="1.4"/><circle class="admin-brand-spark" cx="159.6" cy="9.6" r="1.2"/><circle class="admin-brand-spark" cx="198.8" cy="14.2" r="1.1"/><circle cx="93.2" cy="8.7" r="2.2" fill="url(#adminBrandSparkGradient)" opacity=".66"/></svg>`;
