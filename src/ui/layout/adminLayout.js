...
.admin-brand.admin-brand-legacy{position:relative;display:inline-block;letter-spacing:.13em;text-transform:uppercase;color:var(--text);padding-bottom:2px}
.admin-brand.admin-brand-legacy::after{content:'';position:absolute;left:0;bottom:0;width:100%;height:1px;background:linear-gradient(90deg,transparent,var(--accent),transparent);opacity:.75}
