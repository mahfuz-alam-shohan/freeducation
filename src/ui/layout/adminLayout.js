...
.admin-menu-toggle{display:inline-flex;align-items:center;justify-content:center;width:38px;height:38px;border-radius:10px;border:1px solid #2a3d5c;background:#142036;color:#e9eef8;cursor:pointer;transition:background .2s ease,transform .28s cubic-bezier(.22,1,.36,1),box-shadow .28s cubic-bezier(.22,1,.36,1)}
.admin-menu-toggle:hover{background:#1d2d48;transform:translateY(-1px) scale(1.02)}
.admin-menu-toggle:active{transform:scale(.95)}
body.menu-open .admin-menu-toggle{transform:rotate(90deg)}
...
.admin-avatar{display:inline-flex;align-items:center;justify-content:center;width:36px;height:36px;border-radius:999px;border:1px solid #2a3d5c;background:linear-gradient(180deg,#213354,#172640);color:#f2f6ff;font-size:.82rem;font-weight:700;cursor:pointer;letter-spacing:.02em;transition:transform .22s cubic-bezier(.22,1,.36,1),box-shadow .22s ease,filter .22s ease}
...
.admin-sidebar{position:fixed;z-index:40;left:0;top:0;bottom:0;width:min(272px,86vw);background:#0f1728;border-right:1px solid #24344f;padding:10px;display:grid;grid-template-rows:auto 1fr;gap:10px;transform:translateX(-100%);transition:transform .24s cubic-bezier(.22,1,.36,1)}
...
body.profile-open .admin-profile-pop{opacity:1;transform:translateY(0) scale(1);pointer-events:auto}
.admin-content{padding:11px 11px;display:grid;gap:10px;align-content:start;animation:section-in .35s ease both;transition:opacity .18s ease,transform .18s ease,filter .18s ease}
