...
const SITE_LOGO_SVG = `<svg class="site-logo-svg" viewBox="0 0 248 52" aria-hidden="true" focusable="false"><defs><linearGradient id="siteLogoWordGradient" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="color-mix(in srgb,var(--accent,#b28a58) 90%,#fff)"/><stop offset="100%" stop-color="color-mix(in srgb,var(--accent,#b28a58) 58%,#392516)"/></linearGradient></defs><text class="site-logo-word-stroke" x="8" y="34.5">Freeducation</text><text class="site-logo-word" x="8" y="34.5">Freeducation</text><path class="site-logo-accent" d="M9.2 40.2h164.6"/></svg>`;
