...
.login-card{background:var(--surface);border:1px solid var(--border);border-radius:8px;padding:8px;width:100%;display:grid;gap:8px;align-self:start;animation:section-in .5s ease both}
