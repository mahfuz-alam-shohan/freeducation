...
.login-page{min-height:100vh;display:grid;grid-template-rows:auto 1fr auto;gap:8px;padding:8px 8px max(8px,env(safe-area-inset-bottom))}
...
.login-card{background:#101b30;border:1px solid #24344f;border-radius:8px;padding:10px;max-width:none;width:100%;display:grid;align-self:start;animation:section-in .46s ease both}
