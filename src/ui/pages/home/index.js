...
.home-cover-quote p{margin:0;max-width:34ch;min-height:4.5em;color:#fff;font-size:clamp(1rem,2.4vw,1.25rem);line-height:1.48;text-wrap:balance;transform-origin:left center;animation:quoteTextIn .65s cubic-bezier(.25,.84,.34,1) both}
...
@media (max-width:760px){.home-cover{padding:8px 6px;justify-items:center}.home-cover-inner{gap:5px;justify-items:center;text-align:center}.home-cover-title{display:none}.home-cover-quote{margin-top:0;width:100%;justify-items:center}.home-cover-quote::before{left:50%;transform:translateX(-50%);top:-.62em}.home-cover-quote p{font-size:1rem;line-height:1.35;max-width:28ch;min-height:4em;transform-origin:center}.home-cover-quote cite{transform-origin:center}.home-orbit{opacity:.32;right:-18vmin;top:auto;bottom:-9vmin;width:62vmin;height:62vmin}}
`;
...
(() => {
  ...
  const typeQuote = (entry = {}) => {
    ...
    const typeTimer = window.setInterval(() => {
      quote.textContent = text.slice(0, charIndex + 1);
      charIndex += 1;
  ...
  const rotate = () => {
    ...
    window.setTimeout(() => {
      ...
      const cycleDelay = typeQuote(next);
