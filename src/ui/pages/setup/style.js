...
.setup-page{min-height:100vh;display:grid;grid-template-rows:auto 1fr auto;gap:10px;padding:14px 12px max(14px,env(safe-area-inset-bottom))}
...
.setup-card{background:#101b30;border:1px solid #24344f;border-radius:10px;padding:12px;max-width:460px;width:100%;display:grid;align-self:start;animation:section-in .46s ease both}
...
@media (min-width:720px){
  .setup-page{justify-content:center;align-content:center;padding:16px}
