...
.setup-page{min-height:100vh;display:grid;grid-template-rows:auto 1fr auto;gap:8px;padding:8px 8px max(8px,env(safe-area-inset-bottom));width:min(100%,560px);margin:0 auto}
...
@media (min-width:720px){
  .setup-page{padding:10px;width:min(100%,600px)}
}
`;
