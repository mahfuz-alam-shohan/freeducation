...
.social-page{display:grid;gap:8px;max-width:860px;margin:0 auto}
.social-card{border:1px solid var(--border);background:var(--surface);border-radius:10px;padding:8px}
...
.social-form textarea,.social-comment-form input{width:100%;border:1px solid var(--border);background:var(--surface-soft);color:var(--text);border-radius:8px;padding:6px 8px;font:inherit}
...
.post-card{border:1px solid var(--border);background:var(--surface);border-radius:10px;padding:8px;display:grid;gap:7px}
.post-head{display:flex;gap:7px;align-items:center}
...
.post-meta{display:grid;line-height:1.2}
.post-author{font-size:.92rem;font-weight:600}
.post-time{font-size:.78rem;color:var(--text-muted)}
.post-body{white-space:pre-wrap;word-break:break-word;font-size:.93rem}
...
.comment-item{border:1px solid var(--border);border-radius:8px;background:var(--surface-soft);padding:5px 7px;font-size:.88rem}
.comment-author{font-weight:600;font-size:.85rem}
.social-comment-form{display:flex;gap:6px}
