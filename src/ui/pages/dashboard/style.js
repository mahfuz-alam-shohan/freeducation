...
.dash-bg-icon-admins svg path:first-child{fill:color-mix(in srgb,var(--accent) 25%,transparent)}
...
@media (min-width:700px){
  .dash-grid{gap:10px}
  .dash-card{min-height:132px;padding:10px 11px 11px;gap:7px}
