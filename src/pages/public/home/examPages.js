...
export function withFloatingExamButton(content, examHref) {
  return `${content}<a class="exam-float-btn" style="position:fixed;right:max(10px,env(safe-area-inset-right));bottom:max(12px,env(safe-area-inset-bottom));z-index:60;background:#1d4ed8;color:#fff;border-radius:999px;padding:10px 14px;font-weight:700;text-decoration:none;box-shadow:0 10px 24px rgba(30,64,175,.34);" href="${h(examHref)}">Exam</a>`;
}
