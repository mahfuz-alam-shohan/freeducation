...
.floating-back-btn { position: fixed; top: 10px; left: 10px; z-index: 40; width: 34px; height: 34px; border: 1px solid var(--line); border-radius: 999px; background: #fff; color: #0f172a; display: inline-grid; place-items: center; text-decoration: none; font-size: 18px; box-shadow: var(--shadow-soft); }
...
@media (max-width: 840px) {
  .floating-back-btn { top: 8px; left: 8px; }
