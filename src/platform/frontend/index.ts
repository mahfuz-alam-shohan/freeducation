...
import { viewByPath } from './routing/view-map';
...
export function getFrontendHtml(pathname: string) {
  ...
  if (pathname.startsWith('/dashboard')) {
    ...
    if (pathname.startsWith('/dashboard/ssc/bangladesh-and-global-studies/cq/questions')) {
    ...
    if (pathname.startsWith('/dashboard/ssc/bangladesh-and-global-studies/mcq')) {
      return renderAppHtml('admin-ssc-bangladesh-global-studies-mcq');
    }
    if (pathname.startsWith('/dashboard/ssc/bangladesh-and-global-studies/topic')) {
      return renderAppHtml('admin-ssc-bangladesh-global-studies-topic');
    }
    if (pathname.startsWith('/dashboard/ssc/bangladesh-and-global-studies/topics')) {
      return renderAppHtml('admin-ssc-bangladesh-global-studies-topics');
    }
    if (pathname.startsWith('/dashboard/ssc/bangladesh-and-global-studies')) {
      return renderAppHtml('admin-ssc-bangladesh-global-studies');
    }
    if (pathname.startsWith('/dashboard/ssc/religion-and-moral-education/cq/questions')) {
      return renderAppHtml('admin-ssc-religion-cq-questions');
    }
    if (pathname.startsWith('/dashboard/ssc/religion-and-moral-education/cq')) {
      return renderAppHtml('admin-ssc-religion-cq-types');
    }
    if (pathname.startsWith('/dashboard/ssc/religion-and-moral-education/mcq')) {
      return renderAppHtml('admin-ssc-religion-mcq');
    }
    if (pathname.startsWith('/dashboard/ssc/religion-and-moral-education/topic')) {
      return renderAppHtml('admin-ssc-religion-topic');
    }
    if (pathname.startsWith('/dashboard/ssc/religion-and-moral-education/topics')) {
      return renderAppHtml('admin-ssc-religion-topics');
    }
    if (pathname.startsWith('/dashboard/ssc/religion-and-moral-education/chapters')) {
      return renderAppHtml('admin-ssc-religion-chapters');
    }
    if (pathname.startsWith('/dashboard/ssc/religion-and-moral-education')) {
