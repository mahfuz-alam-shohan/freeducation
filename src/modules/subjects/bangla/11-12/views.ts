  ...
  return `
    <section class="form-card">
      ...
      <div class="form-actions">
        <form method="post" action="/admin/modules/subjects/bangla/11-12/sahapath/switch">
        ...
        <a class="button-link" href="/admin/modules/subjects/bangla/11-12/sahapath">বাতিল</a>
      </div>
    </section>
  `;
};
...
export const renderBanglaElevenTwelveHome = (): string => `
  <section class="page">
    ...
    <section class="page-section">
      <div class="card-grid">
        <a class="card-link" href="/admin/modules/subjects/bangla/11-12/sahapath">
          <span class="card-title">সহপাঠ</span>
        </a>
        <a class="card-link" href="/admin/modules/subjects/bangla/11-12/literature">
...
export const renderBanglaElevenTwelveLiteratureHome = (): string => `
  <section class="page">
    <header class="page-header">
      <h1 class="page-title">বাংলা সাহিত্য (শ্রেণি ১১-১২)</h1>
    ...
    <section class="page-section">
      <div class="card-grid">
        <a class="card-link" href="/admin/modules/subjects/bangla/11-12/literature/goddo">
          <span class="card-title">গদ্য</span>
        </a>
        <a class="card-link" href="/admin/modules/subjects/bangla/11-12/literature/poddo">
...
export const renderBanglaElevenTwelveSahapathList = (props: {
  ...
  const modalBody = `
    <form class="form-card form-grid" method="post" action="/admin/modules/subjects/bangla/11-12/sahapath/new">
          ...
          ${
            items.length
              ? items
                  .map((item) => {
                    const editBody = `
                      <form class="form-card form-grid" method="post" action="/admin/modules/subjects/bangla/11-12/sahapath/edit">
                    ...
                    return `
                      <li class="item-card">
                        <div class="item-card__main">
                          <a class="item-card__title" href="/admin/modules/subjects/bangla/11-12/sahapath/${item.id}">${escapeValue(item.title)}</a>
                          ...
                          <div class="confirm-delete">
                            ...
                            <div class="confirm-delete__modal" role="dialog" aria-modal="true" aria-labelledby="delete-sahapath-${item.id}-11-12-title">
                              <div class="confirm-delete__panel">
                                ...
                                <form class="confirm-delete__form" method="post" action="/admin/modules/subjects/bangla/11-12/sahapath/delete">
                                  <input type="hidden" name="id" value="${item.id}" />
...
export const renderBanglaElevenTwelveSahapathDetail = (item: BanglaElevenTwelveSahapathItem): string => `
  <section class="page">
    <header class="page-header">
      ...
      <div class="page-actions">
        <a class="button-link" href="/admin/modules/subjects/bangla/11-12/sahapath">পেছনে যান</a>
      </div>
    </header>
  </section>
`;
...
export const renderBanglaElevenTwelveLiteratureList = (props: {
  ...
  const addBody = `
    <form class="form-card form-grid" method="post" action="/admin/modules/subjects/bangla/11-12/literature/${category}/new">
      <label class="form-field">
        <span>নাম লিখুন</span>
        <input name="title" type="text" required />
      </label>
  ...
  return `
    <section class="page">
      <header class="page-header">
        ...
        <div class="page-actions">
          <a class="button-link" href="/admin/modules/subjects/bangla/11-12/literature">পেছনে যান</a>
        </div>
      </header>
      ${successMessage ? `<div class="alert">${escapeValue(successMessage)}</div>` : ""}
      ${errorMessage ? `<div class="alert alert--error">${escapeValue(errorMessage)}</div>` : ""}
          ...
          ${
            items.length
              ? items
                  .map((item) => {
                    const editBody = `
                      <form class="form-card form-grid" method="post" action="/admin/modules/subjects/bangla/11-12/literature/${category}/edit">
                        <input type="hidden" name="id" value="${item.id}" />
                        <label class="form-field">
                          <span>নাম</span>
                          <input name="title" type="text" value="${escapeValue(item.title)}" required />
                    ...
                    return `
                      <li class="item-card">
                        <div class="item-card__main">
                          <a class="item-card__title" href="/admin/modules/subjects/bangla/11-12/literature/${category}/${item.id}">${escapeValue(item.title)}</a>
                        </div>
                        <div class="item-card__actions">
                          ...
                          <div class="confirm-delete">
                            ...
                            <div class="confirm-delete__modal" role="dialog" aria-modal="true" aria-labelledby="delete-${category}-${item.id}-11-12-title">
                              <div class="confirm-delete__panel">
                                ...
                                <form class="confirm-delete__form" method="post" action="/admin/modules/subjects/bangla/11-12/literature/${category}/delete">
                                  <input type="hidden" name="id" value="${item.id}" />
                                  <div class="confirm-delete__actions">
...
export const renderBanglaElevenTwelveLiteratureDetail = (item: BanglaElevenTwelveLiteratureItem): string => `
  <section class="page">
    <header class="page-header">
      ...
      <div class="page-actions">
        <a class="button-link" href="/admin/modules/subjects/bangla/11-12/literature/${item.category}">পেছনে যান</a>
      </div>
    </header>
  </section>
`;
