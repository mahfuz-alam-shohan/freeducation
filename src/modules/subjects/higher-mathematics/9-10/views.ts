import type { HigherMathematicsNineTenChapter } from "./data";
...
export const renderHigherMathematicsNineTenList = (props: {
  items: HigherMathematicsNineTenChapter[];
  ...
  return `
    <section class="page">
      ...
      <section class="page-section">
        <div class="page-actions">
          ${renderModal("add-higher-math-9-10", "Add chapter", addBody, "Add", "button-link button-link--primary")}
        </div>
        <ul class="item-list">
          ${
            items.length
                    ...
                    (item) => `
                      <li class="item-card">
                        <div class="item-card__main">
                          <a class="item-card__title" href="/admin/modules/subjects/higher-mathematics/9-10/${item.id}">${escapeValue(item.title)}</a>
                        </div>
                      </li>
                    `,
                  )
...
export const renderHigherMathematicsNineTenDetail = (item: HigherMathematicsNineTenChapter): string => `
  <section class="page">
    <header class="page-header">
