...
export const mobileShellStyles = `
  ...
  .app-header { display: grid; grid-template-columns: 60px 1fr 80px; align-items: center; padding: 8px 12px; border-bottom: 1px solid var(--color-border); background: var(--color-surface-muted); }
  ...
  .app-footer { padding: 8px 12px; border-top: 1px solid var(--color-border); background: var(--color-surface-muted); color: var(--color-text-muted); }
