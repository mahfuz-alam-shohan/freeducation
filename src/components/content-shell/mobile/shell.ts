...
export const mobileShellStyles = `
  ...
  .app-header { display: grid; grid-template-columns: 60px 1fr 80px; align-items: center; padding: 8px 12px; border-bottom: 1px solid #e3e3e3; }
  ...
  .app-footer { padding: 8px 12px; border-top: 1px solid #e3e3e3; }
