...
export const desktopShellStyles = `
  ...
  .app-header { grid-column: 1 / -1; display: grid; grid-template-columns: 80px 1fr 200px; align-items: center; padding: 8px 12px; border-bottom: 1px solid var(--color-border); background: var(--color-surface-muted); }
  ...
  .app-sidebar { grid-row: 2 / 3; padding: 12px; border-right: 1px solid var(--color-border); background: var(--color-surface-muted); overflow: auto; }
  ...
  .app-footer { grid-column: 1 / -1; padding: 8px 12px; border-top: 1px solid var(--color-border); background: var(--color-surface-muted); color: var(--color-text-muted); }
