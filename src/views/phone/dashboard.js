...
function dashboardShellPhone({ siteName, siteIdentity, userProfile, authAction, bottomNavItems, content }) {
  const topbarSlot = topbar({ siteName, siteIdentity, userProfile, authAction });
