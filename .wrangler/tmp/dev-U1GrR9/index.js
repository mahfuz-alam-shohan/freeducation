...
// src/modules/subjects/definitions/bangladesh-and-global-studies.ts
...
// src/modules/subjects/definitions/accounting.ts
...
// src/modules/subjects/definitions/agriculture-studies.ts
...
var renderPageLayout = /* @__PURE__ */ __name(({ device, content, session, csrfToken }) => {
...
var renderHome = /* @__PURE__ */ __name((device, session, cacheable) => {
...
var renderStudentPage = /* @__PURE__ */ __name((device, session, content) => {
  const csrfToken = createCSRFToken();
...
var renderSignup = /* @__PURE__ */ __name((device, session, errorMessage, values) => {
...
var renderVerification = /* @__PURE__ */ __name((device, session, email, errorMessage) => {
...
var renderConfirmation = /* @__PURE__ */ __name((device, session) => {
...
var handleStudentRoutes = /* @__PURE__ */ __name(async (request, env, context) => {
  ...
  if (url.pathname === "/signup/verify") {
    if (request.method === "GET") {
      ...
      return renderVerification(context.device, context.session, email, email ? void 0 : "Please enter your email.");
    }
    if (request.method === "POST") {
      const formData = await request.formData();
      const email = formData.get("email");
      ...
      if (typeof email !== "string" || typeof code !== "string") {
        return renderVerification(context.device, context.session, void 0, "Please enter the email and code.");
      }
      const normalizedEmail = email.trim().toLowerCase();
...
var getSecurityHeaders = /* @__PURE__ */ __name((config = SECURITY_HEADERS_CONFIG) => {
  const headers = {};
  if (config.enableCSP) {
...
var applySecurityHeaders = /* @__PURE__ */ __name((response, config) => {
...
var applySecurityToResponse = /* @__PURE__ */ __name((response) => {
...
// .wrangler/tmp/bundle-vkylBB/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-vkylBB/middleware-loader.entry.ts
