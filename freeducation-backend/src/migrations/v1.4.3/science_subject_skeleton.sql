...
SELECT id, 'science-subjects-bio-phy-chem-nctb-2010', 'Science-Subjects-Bio-Phy-Chem-NCTB 2010', 'Subject skeleton template.'
FROM module_categories
WHERE key = 'subjects';

INSERT OR IGNORE INTO module_nodes (template_id, parent_id, node_key, server_name, node_type, has_image, sort_order)
SELECT t.id, NULL, 'EXAM_SYSTEM', 'Exam System', 'book', 0, 1
FROM module_templates t
WHERE t.code = 'science-subjects-bio-phy-chem-nctb-2010';

INSERT OR IGNORE INTO module_nodes (template_id, parent_id, node_key, server_name, node_type, has_image, sort_order)
SELECT t.id, NULL, 'CURRICULUM', 'Curriculum', 'book', 0, 2
FROM module_templates t
WHERE t.code = 'science-subjects-bio-phy-chem-nctb-2010';

INSERT OR IGNORE INTO module_nodes (template_id, parent_id, node_key, server_name, node_type, has_image, sort_order)
SELECT t.id, parent.id, 'CURRICULUM_CHAPTERS', 'Chapters', 'part', 0, 1
FROM module_templates t
...
INSERT OR IGNORE INTO module_nodes (template_id, parent_id, node_key, server_name, node_type, has_image, sort_order)
SELECT t.id, parent.id, 'CURRICULUM_TOPICS', 'Topics', 'part', 0, 1
FROM module_templates t
JOIN module_nodes parent
  ON parent.template_id = t.id
...
INSERT OR IGNORE INTO module_nodes (template_id, parent_id, node_key, server_name, node_type, has_image, sort_order)
SELECT t.id, parent.id, 'TOPIC_SHORT_NOTES', 'Short Notes', 'part', 0, 1
FROM module_templates t
JOIN module_nodes parent
  ON parent.template_id = t.id
...
INSERT OR IGNORE INTO module_nodes (template_id, parent_id, node_key, server_name, node_type, has_image, sort_order)
SELECT t.id, parent.id, 'TOPIC_CQ_TWO', 'Understanding', 'part', 0, 2
FROM module_templates t
JOIN module_nodes parent
  ON parent.template_id = t.id
  AND parent.node_key = 'TOPIC_CQ'
...
INSERT OR IGNORE INTO module_nodes (template_id, parent_id, node_key, server_name, node_type, has_image, sort_order)
SELECT t.id, parent.id, 'TOPIC_CQ_THREE', 'Application', 'part', 0, 3
FROM module_templates t
JOIN module_nodes parent
  ON parent.template_id = t.id
  AND parent.node_key = 'TOPIC_CQ'
...
INSERT OR IGNORE INTO module_nodes (template_id, parent_id, node_key, server_name, node_type, has_image, sort_order)
SELECT t.id, parent.id, 'TOPIC_CQ_FOUR', 'HOTS', 'part', 0, 4
FROM module_templates t
JOIN module_nodes parent
  ON parent.template_id = t.id
  AND parent.node_key = 'TOPIC_CQ'
