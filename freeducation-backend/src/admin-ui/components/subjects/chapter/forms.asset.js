...
export function renderQuestionForm(config) {
  ...
  return `
    <div class="card table-card">
      ...
      <form class="table-body question-form" data-form="question-page" data-owner="chapter" data-owner-id="${chapter.id}" data-mode="${mode}" data-type="${typeKey}" data-section="${sectionKey || ''}" data-id="${formId}" data-back-href="${backHref}">
        <div class="form-grid">
          <div class="field">
